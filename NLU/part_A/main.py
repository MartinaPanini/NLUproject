...
if __name__ == "__main__":
    ...
    tmp_train_raw = load_data(os.path.join('NLU/part_A/dataset/ATIS/train.json'))
    test_raw = load_data(os.path.join('NLU/part_A/dataset/ATIS/test.json'))
    ...
    with open(results_txt, "w") as file:
        ...
        file.write(f'epochs used: {sampled_epochs} \n')
